...
class EngineersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create engineer" do
    assert_difference('Engineer.count') do
      post engineers_url, params: { engineer: { birth: @engineer.birth, name: @engineer.name, rut: @engineer.rut } }
    end
  ...
  test "should update engineer" do
    patch engineer_url(@engineer), params: { engineer: { birth: @engineer.birth, name: @engineer.name, rut: @engineer.rut } }
