...
class TechniciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create technician" do
    assert_difference('Technician.count') do
      post technicians_url, params: { technician: { birth: @technician.birth, name: @technician.name, rut: @technician.rut } }
    end
  ...
  test "should update technician" do
    patch technician_url(@technician), params: { technician: { birth: @technician.birth, name: @technician.name, rut: @technician.rut } }
