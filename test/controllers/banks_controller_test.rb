...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference('Bank.count') do
      post banks_url, params: { bank: { acc_type: @bank.acc_type, name: @bank.name, number: @bank.number } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { acc_type: @bank.acc_type, name: @bank.name, number: @bank.number } }
